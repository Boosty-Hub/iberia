...
export default async function LoginPage({ searchParams }: PageProps<'/login'>) {
  ...
  return (
    <main className="flex flex-1 items-center justify-center bg-marca-900 px-4 py-12">
      <div className="w-full max-w-sm">
        {/* En la portada el logo lleva más peso que en la navegación. */}
        <div className="mb-8">
          <Marca tono="oscuro" alto={42} />
        </div>

        <div className="tarjeta p-6">
          <p className="rotulo mb-3">Acceso restringido</p>
          <h1 className="mb-1 text-xl font-bold text-marca-800">Entra al programa</h1>
